export { artistExists, getArtist };

/**
 * @param {Number} artistNumber
 * @returns true if the artist number exists otherwise false
 */
function artistExists(artistNumber) {
  return artistNumber.toString() in artist_data;
}
...
let artist_data = {
  ...
  43: {
    ...
    about: "Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo.",
  },
  44: {
  ...
  81: {
    ...
    about: "Nulla justo. Aliquam quis turpis eget elit sodales scelerisque.",
  },
  82: {
    title: "Senior Developer",
    about:
